...
public class MaquinariaTools(IMaquinariaService service, MaquinariaConsulta config, IAccionesUiCollector accionesUi)
    : QueryableToolBase(config, accionesUi)
{
    public override RecursoCodigo Recurso => RecursoCodigo.Maquinaria;
    ...
    private Task<string> BuscarAsync(PaginacionFilter filtro) =>
