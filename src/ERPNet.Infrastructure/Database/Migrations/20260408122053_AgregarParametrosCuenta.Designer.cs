...
namespace ERPNet.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260408122053_AgregarParametrosCuenta")]
    partial class AgregarParametrosCuenta
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERPNet.Domain.Entities.ApunteContable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateOnly?>("FechaPunteo")
                        .HasColumnType("date");
                    ...
                    b.Property<int?>("IdPunteo")
                        .HasColumnType("int");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<int>("NumDiario")
                        .HasColumnType("int");

                    b.Property<int>("NumLinea")
                        .HasColumnType("int");

                    b.Property<int?>("TipoDiarioId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TipoDiarioId");

                    b.HasIndex("CuentaId", "Fecha");

                    b.HasIndex("Asiento", "NumLinea", "EmpresaId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ERPNet.Domain.Entities.Articulo", b =>
                {
                    ...
                    b.Property<decimal>("Depreciacion")
                        .HasPrecision(5, 2)
                    ...
                    b.Property<decimal>("NivelPedido")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");

                    b.Property<decimal>("NivelReposicion")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");
                    ...
                    b.Property<string>("UnidadMedida2")
                        .HasMaxLength(3)
                        .HasColumnType("nvarchar(3)");

                    b.Property<decimal>("UnidadesCaja")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");

                    b.Property<int>("UnidadesPalet")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERPNet.Domain.Entities.CentroCoste", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERPNet.Domain.Entities.Cuenta", b =>
                {
                    ...
                    b.Property<string>("DescripcionSII")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("ERPNet.Domain.Entities.TipoDiario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("tiposdiario", (string)null);
                });
            ...
            modelBuilder.Entity("ERPNet.Domain.Entities.ApunteContable", b =>
                {
                    b.HasOne("ERPNet.Domain.Entities.CentroCoste", "CentroCoste")
                        .WithMany("Apuntes")
                        .HasForeignKey("CentroCosteId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ERPNet.Domain.Entities.Cuenta", "Cuenta")
                        .WithMany("Apuntes")
                    ...
                    b.HasOne("ERPNet.Domain.Entities.TipoDiario", "TipoDiario")
                        .WithMany("Apuntes")
                        .HasForeignKey("TipoDiarioId")
                        .OnDelete(DeleteBehavior.SetNull);
